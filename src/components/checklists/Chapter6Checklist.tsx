...
export default function Chapter6Checklist({ responses, setResponses, externalCollapsed, setExternalCollapsed }: Props) {
  ...
  const allSectionCodes = ch6Rows.filter((r) => r.isMainSection).map((r) => r.code);
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 18, fontWeight: 700, color: "#111" }}>Chapter 6 — Types of Construction</div>
          <div style={{ fontSize: 14, color: "#555", fontWeight: 400, margin: "4px 0 0" }}>
            This chapter classifies buildings by construction type based on the fire-resistance ratings of structural components, including Types I through V construction.
          </div>
        </div>
      ...
      {ch6Rows.map((row) => {
        ...
        const isHidden = !isMainSection && (() => {
          ...
          let parentCode = "";
          for (const candidate of ch6Rows) {
